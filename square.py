...
class Square:
    def __init__(self, x, y, width, height, game):
        ...
        board_img = pygame.transform.smoothscale(board_img, (int(self.width * self.scale_factor), int(self.height * self.scale_factor)))

        food_img = pygame.image.load('./img/food.jpg')
        food_img = pygame.transform.smoothscale(food_img, (int(self.width * self.scale_factor), int(self.height * self.scale_factor)))

        snake_img = pygame.image.load('./img/snake.jpg')
        snake_img = pygame.transform.smoothscale(snake_img, (int(self.width * self.scale_factor), int(self.height * self.scale_factor)))
        ...
        self.images = {self.states['board']:board_img, self.states['snake']:snake_img, self.states['snake_head']:snake_head_img, self.states['food']:food_img}
        self.img = None
